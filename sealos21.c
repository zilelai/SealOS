...
void process_system_command(char *input) {
    ...
    if (strcmp(cmd, "chmod") == 0) {
        ...
        printf("First, type math marks, chemistry marks, biology marks, physics marks, geography marks and finally history marks before pressing enter\n");
