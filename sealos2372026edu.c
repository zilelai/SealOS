...
void process_system_command(char *input) {
    ...
    if (strcmp(cmd, "chmod") == 0) {
        ...
        printf("                 ..^~:::::::::::....              \n");
            ...
            printf("                   .......^:~^~~^^.               \n");
            printf("\n");
        printf("SealKernel 23.7.2026 EDU\n");
        ...
        printf("SealKernel 16.7.2026 EDU - branched out from SealKernel 16.7.2026. This is strictly for educational use\n");printf("SealKernel 19.7.2026 EDU - Changed writing function of tsastream and fixed overflowing values\n");printf("SealKernel 19.7.2026 More EDU - created users function\n");printf("SealKernel 20.7.2026 EDU - Changed input for user and also restricted normal user to root user so they cannot control the system and also added compress and decompress function\n");printf("SealKernel 21.7.2026 EDU - added own package manager from bpm\n");printf("SealKernel 22.7.2026 EDU - added browser function to show HTML code in website and changed tsastream structure for saving to grades.txt\n");printf("SealKernel 23.7.2026 EDU - added bootloader and function clear\n");}
        ...
        printf("available-t - check how many users are there now in advance\n");
        printf("users - create and go into a user\n");
        printf("users-seal - terminate new user and return to seal user\n");
        ...
        fclose(fptr);
        printf("Writing saved as grades.txt\n");
    ...
    else if (strcmp(cmd, "decomp") == 0)
    {
        ...
        if (strcmp(subcmd, "add") == 0) {
            ...
            if (status == 0) {
                ...
                printf("err: internet connection lost (prob)\n");
            }
        } 
            ...
            if (status == 0) {
                ...
                printf("err: cmake not installed or have problem\n");
            }
        } 
    
    
        else {
            printf("err: unknown subcmd\n");
        }
    }
