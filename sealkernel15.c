...
void process_system_command(char *input) {
    ...
    if (strcmp(cmd, "chmod") == 0) {
        ...
        printf("space-main.cpp - to check space in main.cpp\n");
        printf("tictac - play tic tac toe game\n");
    }
    ...
    else if (strcmp(cmd, "space-main.cpp") == 0){
