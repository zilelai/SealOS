...
void process_system_command(char *input) {
    ...
    if (strcmp(cmd, "chmod") == 0) {
        ...
        if (op == '+'){
            ...
            printf("errcode 16 : operator not found");
        }
    }
    ...
    else if (strcmp(cmd, "decomp") == 0)
    {
        ...
        if (strcmp(subcmd, "add") == 0) {
            ...
            if (status == 0) {
                ...
                printf("errcode 19: internet connection lost (prob)\n");
            }
        } 
            ...
            if (status == 0) {
                ...
                printf("errcode 20: git clone failed\n");
            }
        } 
            ...
            if (status == 0) {
                ...
                printf("errcode 21: cmake not installed or have problem\n");
            }
        } 
    }
        ...
        if (!fp) {
            perror("errcode 21 : failed to run curl");
            return;
        }
