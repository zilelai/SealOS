...
int pkgdownload(const char *url) {
    ...
    if (result == 0) {
        ...
        printf("errcode 4 : failed to install existing package\n");
        return 1;
    }
}
...
void process_system_command(char *input) {
    ...
    if (strcmp(cmd, "chmod") == 0) {
        if (parsed_args < 3) {
            printf("errcode 7 : only 0 and 1 are allowed\n");
        ...
        if (parsed_args < 2) {
            printf("errcode 8 : url not provided\n");
        } else {
        ...
        if (parsed_args >= 2) {
            ...
            printf("errcode 3: file not provided\n");
            return; 
        }
        
        if (notes_mode == 0 && strcmp(arg1, "code.txt") == 0) {
            printf("errcode 9 : permission denied \n");
        } else {
            char compile[512];
            ...
            if (!check) {
                ...
                if (fgets(new_name, sizeof(new_name), stdin) != NULL) {
                    ...
                    if (rename(old_path, new_path) == 0) {
                        ...
                        printf("errcode 10: name not provided\n");
                    }
                }
            }
        }
        ...
        if (parsed_args < 2) {
            ...
            if (mkdir(folder_path, 0777) == 0) {
                ...
                printf("errcode 10 : folder unable to generate\n");
            }
        }
    }
        ...
        if (notes_mode == 0 && parsed_args >= 2 && strcmp(arg1, "notes.txt") == 0) {
            ...
            if (file) {
                ...
                printf("errcode 12 : could not create file\n");
            }
        }
    }
        ...
        if (notes_mode == 0 && parsed_args >= 2 && strcmp(arg1, "code.txt") == 0) {
            ...
            if (file) {
                ...
                printf("errcode 13 : could not open file\n");
            }
        }
    }
        ...
        else printf("errcode 3: file not provided\n");
    }

    else if (strcmp(cmd, "sudo-on") == 0){

        if (strcmp(users, "seal") != 0){
            printf("errcode 14 : user doesn't have sudo power. Exit your user to either root or seal user\n");
        }
        else{
            superior = 1;
            printf("sudo mode\n");
        ...
        printf("w - create/write a file\n");
        printf("r - read the contents of a file\n"); 
        printf("rnm - rename a file to something else\n");
        printf("chmod notes.txt 1 - change a file to public\n");
        printf("chmod notes.txt 0 - change a file to private\n");
        printf("mkdir (folder name) - create (folder)\n"); 
        ...
        printf("pkgmgr add (single file url) - only downloads a file from github or anywhere else\n");
        printf("pkgmgr clone (multi file url) - downloads multiple file from github or anywhere else\n");
        printf("pkgmgr build (downloaded file) - run or use a downloaded file (some repositories cannot)\n");
        printf("browser - a function that let you see HTML code inside a website\n");
        printf("clear - a function that clears your screen\n");
        printf("game8 - a lamp guessing game\n");
    }
        ...
        printf("Which version do you want to choose?\n");
        printf("1. Normal Version\n");
        printf("2. New Version\n");
        scanf("%d", &input);
        ...
        if (input == 1){
            ...
            printf("2026 New Term Expectation: %s\n", classExpectation);
        }
            ...
            printf("Only 1 and 2 allowed. Retype this function to try again.\n");
            return;
        }

        printf("Do YOU want to write into a file?\n");
        printf("Yes - 1\n");
        printf("No - Other numbers\n");
        scanf("%d", &file2);
        if (file2 == 1){
            printf("What file do you want to write into? (example: filename.txt)\n");
            printf("NOTE that if you key in an existing file it would not overwrite but instead append it\n");
            scanf("%127s", file1);
        ...
        if (op == '+'){
            ...
            printf("errcode 15 : operator not found");
        }
    }
        ...
        char input[256];
        printf("Prompt out your file/directory: ");
        ...
        if (scanf("%127s", input) != 1) {
            printf("errcode 17 : input failed to read\n");
            return; 
        }
        ...
        if (ImageData) {
            ...
            printf("errcode 18 : image loading failed, %s\n", stbi_failure_reason());
        }
    }
        ...
        else{printf("errcode 19 : user input failed\n");}
    }
    ...
    else if (strcmp(cmd, "decomp") == 0)
    {
        ...
        if (strcmp(subcmd, "add") == 0) {
            ...
            if (status == 0) {
                ...
                printf("errcode 20: internet connection lost (prob)\n");
            }
        } 
            ...
            if (status == 0) {
                ...
                printf("errcode 22: cmake not installed or have problem\n");
            }
        } 
    }
        ...
        printf("What website do you want to go to? ");
        fflush(stdout); 
        ...
        int guess = rand() % 15;
        char answer [128];
        printf("Guess the Lamp\n");
        if (guess == 1){
            printf("It is made by schreder, contains lots of types but mainly uses SON/HPS. Finally, it is the highest watts inside one if the most popular schreder lamps. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder Z3")== 0){
                printf("Correct!!!\n");
            }
            else{
            ...
            printf("Made by Thorn and I am the version 8 of a series");
            scanf("%127s", answer);
            if (strcmp(answer, "Thorn Alpha 8")== 0){
                printf("Correct!!!\n");
            }
            else{
                printf("try again bro\n");
            ...
            printf("Structure similar to Thorn Alpha 8, made by Philips. ");
            scanf("%127s", answer);
            if (strcmp(answer, "SGS 304")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("Another Schreder big hit and it is in Federal Highway. ");
            scanf("%127s", answer);

            if (strcmp(answer, "Schreder DZ60")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("Schreder's big hit but instead of the highest watts it has the lowest watts. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder Z1") == 0){
                printf("Correct!!!\n");
            }
            ...
            printf("Similar to schreder z2 but it has lower watts than z2 but similar to z1. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder Z18")== 0){
                printf("Correct!!!\n");
            }
            else{
                printf("try again bro\n");
            ...
            printf("Malaysia made lamp similar to Lunoida. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Nikkon S419")== 0){
                printf("Correct!!!\n");
            }
            else{
                printf("try again bro\n");
            ...
            printf("First schreder lamp. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder PQ")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("Schreder lamp that looks like Saturn. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder Saturn")== 0){
                printf("Correct!!\n");
            }
            ...
            printf("Made by Thorn and also can be seen in Salak Highway (maybe). ");
            scanf("%127s", answer);
            if (strcmp(answer, "Thorn Alpha 3")== 0){
               printf ("Correct!!!\n");
            }
            ...
            printf("One of the thinnest street light that Thorn has ever made. ");

            scanf("%127s", answer);
            if (strcmp(answer, "Thorn Alpha 4")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("Schreder lamp similar to Thorn Alpha 8 and SGS 203. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder MC")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("A Philips street lamp and only have HPS and Mercury. ");
            scanf("%127s", answer);
            if (strcmp(answer, "SGS203")== 0){
                printf("Correct!!!\n");
            }
            ...
            printf("A Schreder lamp that is really similar to SGS201. It's the only lamp in this game that has Cosmopolis and it is seal safe. ");
            scanf("%127s", answer);
            if (strcmp(answer, "Schreder Sapphire")== 0){
                printf("Correct!!!\n");
            }
...
//Jump Pad : 2
        ...
        int input;
        int input2;
        printf("Welcome to sniping game\n");
        printf("Pick your primary weapons: \n");
        printf("Available primary: Sniper (1), Crossbow (2)\n");
        printf("Pick your weapons by typing it with gun codes: ");
        scanf("%d", &primary);
        if (primary == 1){
            printf("You picked sniper\n");
        }
        else if (primary == 2){
            printf("You picked crossbow\n");
        }
        printf("Pick your secondary weapons: \n");
        printf("Available secondary: Daggers (1), Revolver (2)\n");
        printf("Pick your weapons by typing it with gun codes: ");
        scanf("%d", &secondary);
        if (primary == 1){
            printf("You picked daggers\n");
        }
        else if (primary == 2){
            printf("You picked revolver\n");
        }
        printf("Pick your melee: \n");
        printf("Available melees: Scythe (1), Knife (2)\n");
        printf("Pick your weapons by typing it with melee codes: ");
        scanf("%d", &melee);
        if (primary == 1){
            printf("You picked scythe\n");
        }
        else if (primary == 2){
            printf("You picked knife\n");
        }
        printf("Pick your utility: \n");
        printf("Available utilities: Medkit (1), Jump Pad (2)\n");
        printf("Pick your weapons by typing it with utility codes: ");
        scanf("%d", &utility);
        if (primary == 1){
            printf("You picked medkit\n");
        }
        else if (primary == 2){
            printf("You picked jump pad\n");
        }
        printf("So your main codes are: %d, %d, %d, %d,\n", primary, secondary, melee, utility);

        printf("\n");
        printf("ROUND 1/3\n");
        printf("Your opponent placed a jump pad but still visible to you\n");
        printf("What type of weapon do you equip? ");
        scanf("%d", &input);
        if (input == 1){
            if (input == 1){
                sleep(1);
                printf("Headshot! Opponent had died\n");
            }
            else if (input == 2){
                sleep(10);
                printf("Headshot! Opponent had died\n");
            ...
            if (input == 1){
                sleep(30);
                printf("It has been rough... You lost 70 of your HP, but you killed him!\n");
            }
            else if (input == 2){
                sleep(20);
                printf("It has been rough... You lost 40 of your HP, but you killed him!\n");
            }
        }
            ...
            if (input == 1){
                sleep(30);
                printf("You dashed but your opponent found and killed you. YOU ARE OUT OF THE MATCH!\n");
            }
            else if (input == 2){
                sleep(10);
                printf("You sneak attack and backstabbed him! Good work!!!\n");
            }
        }
            ...
            if (input == 1){
                sleep(30);
                printf("Worst decision ever yet!!! Now opponent found you and sniped. YOU ARE OUT OF THE MATCH\n");
            }
            else if (input == 2){
                sleep(10);
                printf("Worst decision ever yet!!! Now opponent found you and sniped. YOU ARE OUT OF THE MATCH\n");
        ...
        else {printf("errcode 2 : sudo user undetected, switch to sudo user\n");}
        
    }

    else {
        printf("errcode 1 : command not found\n");
    }
